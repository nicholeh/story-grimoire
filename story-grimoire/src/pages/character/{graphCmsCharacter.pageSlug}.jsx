                ...
                <div className="container mx-auto">
                    <Grid className="lg:grid-cols-5 xl:grid-cols-3 lg:gap-x-32 xl:gap-x-40">
                        ...
                        <section className="lg:col-span-3 xl:col-span-2 lg:order-1 lg:pt-2 mt-14 lg:mt-0">
                            <div className="mb-8">{character.description}</div>
                            ...
                            <div className="py-10">
                                <h2 className="sg-title-1">Personality</h2>
                                <div
                                    dangerouslySetInnerHTML={{
                                        __html: character.personality.html,
                                    }}
                                    className="mt-8"
                                />

                                <h3 className="sg-title-2 mt-8">Knowledge</h3>
                                <div
                                    dangerouslySetInnerHTML={{
                                        __html: character.knowledge.html,
                                    }}
                                    className="mt-4"
                                />

                                <h3 className="sg-title-2 mt-8">Wound</h3>
                                <div
                                    dangerouslySetInnerHTML={{
